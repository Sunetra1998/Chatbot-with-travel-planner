    ...
    <div className='questions container'>
      ...
      <div className="secContainer grid">
        ...
        preferences and offer attractions or activities you find appealing.'
          ...
          destination you're interested in. Opt for shoulder seasons when the weather is pleasant, 
          ...
          <Accordion
            ...
            desc="Look for travel deals, discounts on flights and accomodations, and consider using
            travel apps or websites that offer competitive prices. Being flexible with your travel
            dates can also help you find better deals."
            active={active}
            setActive={setActive}
          />
          ...
          <Accordion
            ...
            essential medications, andany specific gear needed for your adventure
        ...
        <div className="form">
          <div className="secHeading">
            ...
            <p data-aos='fade-up'>Please fill the form below and our dedecated team will get intouch with you as soon as possible.</p>
          </div>
